 ...
 * @date 2018/12/17
 */
public class InsertMethodControllerModel extends BaseMethod {
    ...
    public InsertMethodControllerModel(GeneratorCentext generatorCentext, ClassProperty topClassProperty, VariableProperty entityVariable) {
