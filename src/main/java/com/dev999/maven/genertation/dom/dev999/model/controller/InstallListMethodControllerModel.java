 ...
 * @date 2018/12/17
 */
public class InstallListMethodControllerModel extends BaseControllerDefaultModel {
    public InstallListMethodControllerModel(ClassProperty topClassProperty, VariableProperty serviceVariable, VariableProperty entityVariable, CommonGeneratingParam commonGeneratingParam, boolean interfaceClass) {
