 ...
 * @date 2018/12/17
 */
public class DeleteByIdMethodControllerModel extends BaseMethod {
    ...
    public DeleteByIdMethodControllerModel(GeneratorCentext generatorCentext, ClassProperty topClassProperty, VariableProperty entityVariable) {
